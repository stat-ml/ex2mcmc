...
from paths import (path_to_save_remote, 
                   path_to_save_local_swissroll,
                   port_to_remote)

import importlib
train_jensen = False
if train_jensen:
   module_name =  'params_swissroll'
else:
   module_name =  'params_swissroll_wasserstein' 
...
from toy_examples_utils import (prepare_swissroll_data, 
...
new_dir = os.path.join(path_to_save_local_swissroll, cur_time)
os.mkdir(new_dir)
