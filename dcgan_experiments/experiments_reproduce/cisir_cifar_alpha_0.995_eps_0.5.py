...
from sir_ais_sampling import (cisir_adaptive_sampling)
...
method_name = 'adaptive_cisir_dcgan_cifar_recalc'
...
method_name = f'adaptive_cisir_dcgan_recalculate_stats_700_steps_alpha_{alpha}_eps_{bernoulli_prob_corr}'
dataset = "cifar10"
calculate_is = False
