...
def mh_sampling_normal_proposal_plot_2d(target,
                                        ...
                                        latent_transform=None):
    batchsize = batch_size_sample // n_batches
    X_mh, zs = mh_sampling_normal_proposal(target, proposal,
                                           batchsize, batch_size_sample,
                                           None, None, None, None,
...
def sir_correlated_plot_2d(target,
                           ...
                           latent_transform=None):
    batchsize = batch_size_sample // n_batches
    X_mh, zs = sir_correlated_sampling(target, proposal,
                                       batchsize, batch_size_sample,
                                       None, None, None, None,
                                       n_steps, N, alpha)
    if latent_transform is not None:
...
def sir_independent_plot_2d(target,
                            ...
                            latent_transform=None):
    batchsize = batch_size_sample // n_batches
    X_mh, zs = sir_independent_sampling(target, proposal,
                                        batchsize, batch_size_sample,
                                        None, None, None, None,
                                        n_steps, N)
    if latent_transform is not None:
